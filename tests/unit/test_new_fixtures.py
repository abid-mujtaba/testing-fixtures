...
from .utils import fixture_factory_a, Ao
from .utils import fixture_factory_b, Bi1, Bi2, Bo
from .utils import fixture_factory_c, Co
from .utils import fixture_factory_d, Di, Do
...
def test_a_as_contextmanager() -> None:
    ...
    with fixture_factory_a() as a:  # pylint: disable=E1129
        assert a == "a"


@fixture_factory_b(Bi1(42), Bi2(3.14))
def test_b(b: Bo) -> None:
    """Test parametrized fixture_b in isolation."""
    assert b == {"b1": 42, "b2": 3.14}


@fixture_factory_b(Bi1(88), Bi2(12.3))
@fixture_factory_a()
